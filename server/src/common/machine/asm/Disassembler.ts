...
import {InstRec} from "../sim/Tracer.js";
import {LabelsComments} from "./asm.js";
import {ByteDeclaration} from "./ByteDeclaration.js";
import {DisassemblyMeta} from "./DisassemblyMeta.js";
import {Edict} from "./Edict.js";
import {FullInstructionLine, InstructionLike, SymDef} from "./instructions.js";
import {InstructionSet} from "./InstructionSet.js";
import {OpSemantics} from "./Op.js";
...
class Disassembler {
  ...
  // future: perf test adding a cache of address to instruction
  ...
  instructionByteAhead = (n: number) => {
    ...
    const isEntryPoint = entries.find(ar => ar.index === address) !== undefined;
